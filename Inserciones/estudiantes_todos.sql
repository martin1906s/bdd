...
values('175013192','Martín','Simbaña','martin.simbana007@gmail.com','19/06/2007')

insert into estudiantes(cedula,nombre,apellido,email,fecha_nacimineto)
values('175013193','Mario','Bros',' mario.bros07@gmail.com','19/10/1997')

insert into estudiantes(cedula,nombre,apellido,email,fecha_nacimineto)
values('175013134','Abigail','Herrera','abigail.herrera@gmail.com','9/06/1999')

insert into estudiantes(cedula,nombre,apellido,email,fecha_nacimineto)
values('1750131925','Alexandra','Simbaña','alexaflor007@gmail.com','19/06/1867')

insert into estudiantes(cedula,nombre,apellido,email,fecha_nacimineto)
values('1715614788','Chirstian','Simbaña','cris.simba45@gmail.com','30/10/1987')

insert into estudiantes(cedula,nombre,apellido,email,fecha_nacimineto)
values('1765430987','Miguel','Flores','miguelAng@gmail.com','10/09/1867')

insert into estudiantes(cedula,nombre,apellido,email,fecha_nacimineto)
values('0956759870','Wendy','Balseca','wdy@gmail.com','14/02/2006')

insert into estudiantes(cedula,nombre,apellido,email,fecha_nacimineto)
values('6834657890','Mathias','Simbaña','mthsimabnaFlor@gmail.com','24/06/2000')
